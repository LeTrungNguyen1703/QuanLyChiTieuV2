...
public class SecurityConfig {
    ...
    final WalletPermissionService walletPermissionService;
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.authorizeHttpRequests(request ->
                request.requestMatchers(HttpMethod.POST, PUBLIC_ENPOINT).permitAll()
                        ...
                        // Các endpoint liên quan đến ví tiền yêu cầu xác thực
                        .requestMatchers("/vitien/**").authenticated()
                        .requestMatchers("/khoanchi/**").authenticated()
                        .requestMatchers("/khoanthu/**").authenticated()
